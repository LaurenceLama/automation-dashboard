        ...
        <section className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              an <strong>HTTP Request</strong> or <strong>Webhook </strong>
              step at the END of your workflow.
            </p>
          ...
          <div className="space-y-2">
            ...
            <p>This identifies which workflow sent the execution.</p>
          ...
          {/* PAYLOAD */}
          <div className="space-y-2">
            <p className="font-semibold">Step 3 — Send this JSON payload</p>
          ...
          <p className="text-sm opacity-80">
            💡 This step does NOT trigger your automation. It only reports
            successful runs to your dashboard.
          </p>
